...
DB_PASSWORD=[REDACTED - SET IN KINSTA DASHBOARD]
```
...
APP_ENV=production
APP_KEY=[REDACTED - GENERATE WITH: php artisan key:generate]
APP_DEBUG=false
...
MAIL_PORT=587
MAIL_USERNAME=[REDACTED - GET FROM POSTMARK DASHBOARD]
MAIL_PASSWORD=[REDACTED - GET FROM POSTMARK DASHBOARD]
